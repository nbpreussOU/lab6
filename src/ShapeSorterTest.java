...
public class ShapeSorterTest
{
	...
	public void SortShapesPerimeterTest()
	{
		...
		Assert.assertEquals("SortShapes gave incorrect ordering.", sorter.shapes.get(0), a);
		Assert.assertEquals("SortShapes gave incorrect ordering.", sorter.shapes.get(1), b);
